...
<body>
    <div class="container">
        ...
        */
        ...
        $tydrukud = array("Subaru","BMW","Acura","Lexus","GMC","Volvo","Toyota","Volkswagen");
        sort($tydrukud);
        ...
        <h2>Tüdrukud II</h2>
        <?php
        echo "Esimesed 3: ".$tydrukud[0].", ".$tydrukud[1].", ".$tydrukud[2]."<br>";
        echo "Viimane: ".end($tydrukud)."<br>";
        $rng = rand(0,7);
        echo "Suvaline: ".$tydrukud[$rng]
        ?>
        <h2>Autod</h2>
        <?php
        ...
        if ($autode_arv == $vin_arv){
            ...
            echo "Massiivid pole ühepikkused";
        }
        
        echo "<br>Toyotasi nimekirjas: ".array_count_values($autod)["Toyota"];
        echo "<br>Audisi nimekirjas: ".array_count_values($autod)["Audi"]."<br>";

        echo "<br>VIN koodid alla 17: <br>";
